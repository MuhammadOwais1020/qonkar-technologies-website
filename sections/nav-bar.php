    ...
    <div class="header-logo">
      ...
      <div class="header-navbar">
        <div class="zk-navbar-inner bg-white w-100 d-block position-relative">
          <nav class="navbar">
            <p class="mb-0 h2">Our products</p>
            ...
            <div class="menu-new-mega-menu-container">
              <ul id="mega-menu" class="zk-mega-menu">
                ...
                <li id="menu-item-147693"
                  ...
                  <a href="#">Services</a>
                  <ul class="sub-menu">
                    <button type="button" class="zk-back-cta">
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M3.825 9L9.425 14.6L8 16L0 8L8 0L9.425 1.4L3.825 7H16V9H3.825Z" fill="#1C1B1F"></path>
                      </svg>
                    </button>
                    <li id="menu-item-171695"
                      ...
                      <div class="cateorgy_namee">
                        ...
                        <ul class="menu_items">
                          <li>
                            <a href="https://www.qonkar.com/services/landing-page-design.php">
                              <span class="icon">
                          ...
                          <li>
                            <a href="https://www.qonkar.com/services/web-portals.php">
                              <span class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="6" height="10" fill="none"
                                  viewBox="0 0 6 10">
                                  <path d="M6 5L1.758 9.243.344 7.828 3.172 5 .344 2.172 1.758.757 6 5z">
                          ...
                          <li>
                            <a href="https://www.qonkar.com/services/custom-website-design-maintenance.php">
                              <span class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="6" height="10" fill="none"
                                  viewBox="0 0 6 10">
                                  <path d="M6 5L1.758 9.243.344 7.828 3.172 5 .344 2.172 1.758.757 6 5z">
                      ...
                      <div class="cateorgy_namee">
                        ...
                        <ul class="menu_items">
                          <li>
                            <a href="https://www.qonkar.com/services/ppc-facebook-ads.php">
                              <span class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="6" height="10" fill="none"
                                  viewBox="0 0 6 10">
                                  <path d="M6 5L1.758 9.243.344 7.828 3.172 5 .344 2.172 1.758.757 6 5z">
                              ...
                              Paid Advertising (PPC and Facebook)
                            </a>
                          </li>
                          <li>
                          ...
                          <li>
                            <a href="https://www.qonkar.com/services/email-marketing.php">
                              <span class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="6" height="10" fill="none"
                                  viewBox="0 0 6 10">
                                  <path d="M6 5L1.758 9.243.344 7.828 3.172 5 .344 2.172 1.758.757 6 5z">
                          ...
                          <li>
                            <a href="https://www.qonkar.com/services/social-media-management.php">
                              <span class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="6" height="10" fill="none"
                                  viewBox="0 0 6 10">
                                  <path d="M6 5L1.758 9.243.344 7.828 3.172 5 .344 2.172 1.758.757 6 5z">
                      ...
                      <div class="cateorgy_namee main-title">
                        ...
                        <div class="menu_content">
                          <img
                            src="https://www.tekrevol.com/static/ffb491df1ecfbff5c7ea31348d1593af/76800/iphone-15-pro-big.webp"
                ...
                <!-- <li id="menu-item-147693"
                  class="zk-menu-one menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-147693">
                  <a href="https://Qonkardk/brancher/">Industries</a>
                  <ul class="sub-menu">
                    <button type="button" class="zk-back-cta">
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M3.825 9L9.425 14.6L8 16L0 8L8 0L9.425 1.4L3.825 7H16V9H3.825Z" fill="#1C1B1F"></path>
                    ...
                    <li id="menu-item-171695"
                      ...
                      <div class="cateorgy_namee">
                        <h4>
                          <a aria-current="page" class="" href="/mobile-app-development">Mobile App Development
                          </a>
                        </h4>
                        <ul class="menu_items">
                          <li>
                ...
                <li id="menu-item-147693"
                  class="zk-menu-one menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-147693">
                  <a href="https://Qonkardk/brancher/">Insights</a>
                  <ul class="sub-menu">
                    <button type="button" class="zk-back-cta">
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M3.825 9L9.425 14.6L8 16L0 8L8 0L9.425 1.4L3.825 7H16V9H3.825Z" fill="#1C1B1F"></path>
