  ...
  <div class="container">
    <div class="row">
      <div class="row-content">
        ...
        <p>We thrive on accelerating the path to disruption and implementing agile methodologies to design, build,
          deliver, and scale digital solutions. Our future-proof, growth-centric tech has earned us notable awards and
          recognition across industries and regions.</p>
      </div>
    </div>
      ...
      <div class="awards-content">
        <div class="award-wrap">
          <div class="award-image-sec">
            <div class="image">
              <img src="images/inc-5000.webp" alt="">
            </div>
          </div>
        ...
        <div class="award-wrap">
          <div class="award-image-sec">
            <div class="image">
              <img src="images/dot-com.webp" alt="">
            </div>
          </div>
          <div class="award-content">
            <h5>Dot Comm</h5>
        ...
        <div class="award-wrap">
          <div class="award-image-sec">
            <div class="image">
              <img src="images/Clutch.webp" alt="">
            </div>
          </div>
          <div class="award-content">
            <h5>Clutch</h5>
        ...
        <div class="award-wrap">
          <div class="award-image-sec">
            <div class="image">
              <img src="images/top_developer.webp" alt="">
            </div>
          </div>
          <div class="award-content">
        ...
        <div class="award-wrap">
          <div class="award-image-sec">
            <div class="image">
              <img src="images/expertise-logo.webp" alt="">
            </div>
          </div>
          <div class="award-content">
            <h5>Expertise</h5>
        ...
        <div class="award-wrap">
          <div class="award-image-sec">
            <div class="image">
              <img src="images/top_Reated.webp" alt="">
            </div>
          </div>
          <div class="award-content">
        ...
        <div class="award-wrap">
          <div class="award-image-sec">
            <div class="image">
              <img src="images/Horizon.webp" alt="">
            </div>
          </div>
          <div class="award-content">
            <h5>Horizon Award</h5>
        ...
        <div class="award-wrap">
          <div class="award-image-sec">
            <div class="image">
              <img src="images/rank-watch.webp" alt="">
            </div>
          </div>
          <div class="award-content">
            <h5>Rank Watch</h5>
        ...
        <div class="award-wrap">
          <div class="award-image-sec">
            <div class="image">
              <img src="images/right-firms.webp" alt="">
            </div>
          </div>
          <div class="award-content">
            <h5>Right firms</h5>
