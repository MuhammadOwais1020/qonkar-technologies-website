    ...
    <section class="hero-section">
      <div class="hero-section-title">
        <div class="hero-head">
          ...
          <h1 class="heading subheading" style="font-size: 28px; margin-bottom: 8px">Expert PPC & Facebook Ads Solutions for Every Business</h1>
        </div>
    ...
    <section class="section-service-details">
      ...
      <div class="sub-services">
        <div class="sub-service">
          <div class="section-heading">
            <h2 class="heading">Campaign Strategy & Development</h2>
          </div>
          <p>
            We engage first by creating your business goals which revolve around the concerns of your target audience.
            Our crew of specialists then formulates customized ads like Google, Facebook, and Instagram to reach the
            correct people at the right moment.
          </p>
        </div>

        <div class="sub-service">
          <div class="section-heading">
            <h2 class="heading">Ad Creation & Design</h2>
          </div>
          <p>
            The core of our campaigns is engaging and highly visible ads. Our talented team makes ads that are appealing
            and say clear calls to action that connect with your audience.
          </p>
        </div>

        <div class="sub-service">
          <div class="section-heading">
            <h2 class="heading">Audience Targeting & Segmentation</h2>
          </div>
          <p>
            Through advanced targeting options, we ensure that your ads are seen only by the users who are actually
            interested in them. We use demographic targeting, interest-based targeting, or custom audience segmentation
        ...
        <div class="sub-service">
          <div class="section-heading">
            <h2 class="heading">Keyword Research & Optimization</h2>
          </div>
          <p>
            By keyword analysis for PPC campaigns, our team does a thorough keyword search to make sure your ads show up
            when potential customers look for products or services related to your business.
          </p>
        </div>

        <div class="sub-service">
          <div class="section-heading">
            <h2 class="heading">A/B Testing & Optimization</h2>
          </div>
          <p>
            Day by day, we experiment with various approaches to come up with the right mix of promotional strategies
            that will yield the most desirable outcome. Our process includes A/B testing of various ad creatives,
            different copies, and targeting options to discover the one that gets the best results.
          </p>
        </div>

        <div class="sub-service">
          <div class="section-heading">
            <h2 class="heading">Budget Management & Bid Optimization</h2>
          </div>
          <p>
            The way we handle your budget is that we do it most effectively. Our performance metrics guide us in the
            process of adjusting the bids to the right level, to be able to use the most of every dollar spent.
          </p>
        </div>
