...
?>
 ...
 ?>
  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    const heading = document.querySelector('h1'); // Adjust this selector to your heading element
    ...
    window.addEventListener('scroll', function() {
      if (isInViewport(heading)) {
        svgPath.classList.add('animated');
      }
    });
  });
  </script>
