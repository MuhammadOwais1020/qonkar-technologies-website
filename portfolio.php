...
<body>
            ...
            <div class="project_list">
                <a href="#">
                    <div class="project prj_1">
                        <div class="image">
                            <img src="https://qonkar.com/assets/image/Graphic-image.png" alt="Creative Graphic Design">
                        </div>
                ...
                <a href="#">
                    <div class="project prj_2">
                        <div class="image">
                            <img src="https://qonkar.com/assets/image/web-development-image.png" alt="Expert Web Development">
                        </div>
                        <div class="project_content">
                ...
                <a href="#">
                    <div class="project prj_3">
                        <div class="image">
                            <img src="https://qonkar.com/assets/image/shopify-image.png" alt="Shopify Store Development">
                        </div>
                        <div class="project_content">
    ...
    <div class="pdf-section">
        ...
        <a href="https://qonkar.com/qonkar-technologies-website/Pesticide/Proposal Updated.pdf" class="pdf-button" target="_blank">View Pesticides PDF</a>
    </div>
</body>
</html>
