...
<section class="services-section" id="services-section">
    <div class="container">
      ...
      <div class="services sub-servicess">
        <div class="service">
            <a href="shopify-store-setup.php">
                ...
                <h3 class="sub-heading">Shopify Store Setup</h3>
        ...
        <div class="service">
            <a href="wordpress-development.php">
                ...
                <h3 class="sub-heading">WordPress Development </h3>
                <p class="service-description">
                    SEO <br>
        ...
        <div class="service">
            <a href="website-development.php">
                ...
                <h3 class="sub-heading">Website Development</h3>
                <p class="service-description">
                    Logo Design <br>
        ...
        <div class="service">
            <a href="custom-software-applications.php">
                ...
                <h3 class="sub-heading">Custom Software Applications</h3>
                <p class="service-description">
        ...
        <div class="service">
            <a href="web-applications.php">
                ...
                <h3 class="sub-heading">Web Applications</h3>
                <p class="service-description">
