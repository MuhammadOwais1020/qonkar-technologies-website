...
<head>
  ...
  <script type="application/ld+json">
  {
    ...
    "mainEntity": [{
        "@type": "Question",
        "name": "What IT services does Qonkar Technologies provide?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Qonkar Technologies provides a wide range of IT services including web development, software design, digital marketing, and custom software solutions."
        }
      },
      {
        "@type": "Question",
        "name": "How can I contact Qonkar Technologies for support?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "You can contact us via email or phone for 24/7 customer support. Visit our contact page for more details."
        }
      },
      {
        "@type": "Question",
        "name": "Does Qonkar Technologies offer web development services?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes, we specialize in custom web development including Shopify, WordPress, and full-stack development using the latest technologies."
        }
      }
    ]
  }
      ...
      <div class="faq-container">
        ...
        <div class="faq-item">
          ...
          <label for="faq1" class="faq-label">
            What services does Qonkar Technologies offer?
            <span class="faq-symbol">+</span>
          </label>
          <div class="faq-content">
            We provide Web Development, IT Consulting, Digital Marketing, Shopify Store setup, and other IT-related
            services.
          </div>
        </div>
        ...
        <div class="faq-item">
          ...
          <div class="faq-content">
            The project turnaround time depends on the scope and complexity, but we strive to complete most projects
            within 2-4 weeks.
          </div>
        </div>
