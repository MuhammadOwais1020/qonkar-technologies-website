...
<!-- <section class="head-section">
    <div class="outer-container">
        <div class="heading-container">
            ...
            <h4 class="heading-body">We <span class="text-secondary" >identified</span> by our work. Here are witness th    impact from the <span class="text-secondary" >successful</span><br /> Implimentaion of<spa  class="text-secondary" > Our Projects.</span></h4>
